...
class TraditionalLessonsScreen extends StatefulWidget {
  const TraditionalLessonsScreen({super.key});

  @override
  State<TraditionalLessonsScreen> createState() =>
      _TraditionalLessonsScreenState();
}

class _TraditionalLessonsScreenState extends State<TraditionalLessonsScreen> {
  ...
  Future<List<Map<String, dynamic>>> fetchLessonsWithProgress() async {
    ...
    for (var lesson in lessons) {
      final quizId = 'traditional_${lesson['id']}';
